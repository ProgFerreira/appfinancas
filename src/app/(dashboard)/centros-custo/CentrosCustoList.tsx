            ...
            <table className="w-full text-sm">
              <thead className="bg-slate-50 text-slate-600">
                <tr>
                  ...
                  <th className="text-left p-3">Natureza</th>
              ...
              <tbody>
                {items.length === 0 ? (
                  <tr>
                    <td colSpan={ativoFilter === 'all' ? 6 : 5} className="p-6 text-center text-slate-500">
                  ...
                  items.map((r) => (
                    <tr key={r.id} className="border-t border-slate-100 hover:bg-slate-50">
                      ...
                      <td className="p-3 text-slate-600 capitalize">{r.natureza}</td>
                      <td className="p-3 text-slate-600">{r.natureza_nome ?? '—'}</td>
                      {ativoFilter === 'all' && (
                        <td className="p-3">
                          <span
