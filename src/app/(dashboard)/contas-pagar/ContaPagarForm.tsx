...
export function ContaPagarForm() {
  ...
  const [form, setForm] = useState({
    ...
    forma_pagamento: '',
    tipo_custo: 'variavel' as 'fixo' | 'variavel',
    origem: '',
    cte_id: '' as number | '',
    observacoes: '',
  });
    ...
    <div className="form-card form-contraste">
      ...
      <form onSubmit={handleSubmit} className="p-6">
        <div className="form-grid-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setForm((f) => ({ ...f, tipo_custo: e.target.value as 'fixo' | 'variavel' }))}
            >
        ...
        <div className="form-actions">
          ...
          <Link href="/contas-pagar" className="btn btn-secondary">
            Cancelar
          </Link>
        </div>
      </form>
