...
export function CategoriasDespesaList() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/categorias-despesa?${q}`)
      .then(async (res) => {
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {items.length === 0 ? (
                  <tr>
                    <td colSpan={ativoFilter === 'all' ? 5 : 4} className="p-6 text-center text-slate-500">
